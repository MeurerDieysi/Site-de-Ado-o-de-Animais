...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="contato.php" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CONTATO</a>
    
    <div class="w3-dropdown-hover w3-hide-small">
           
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
          <a href="dicas.php" class="w3-bar-item w3-button">dicas</a>
...
<div id="modal-wrapper" class="modal">
  ...
  <form class="modal-content animate" action="/action_page.php">
    ...
    <div class="imgcontainer">
      ...
      <img src="oab.jpg" alt="Avatar" class="avatar">
      <h1 style="text-align:center">HousePets</h1>
    </div>
    ...
    <div class="container">
      ...
      <a href="index.php" style="text-decoration:none; float:right; margin-right:34px; margin-top:26px;">Forgot Password ?<p>
